...
public class GetDatabase : MonoBehaviour
{
    ...
    public void GetHVACSystem(string HVACName)
    {
        ...
        ClimateControlComponent unit = new ClimateControlComponent("Generic AC", "description", "pros", "cons", new List<ClimateControlComponentTypes>(), false, false, true, 0f, 500f, 0f, 0.015f, ClimateControlComponentTypes.AirConditioner, UtilityType.Electric, (10f, 15f));
        DisplayUnit(unit);
    }
