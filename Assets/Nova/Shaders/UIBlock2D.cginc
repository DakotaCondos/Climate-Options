...
StructuredBuffer<SubQuadVert> _NovaSubQuadVerts;
...
StructuredBuffer<UIBlock2DData> _NovaData;
...
v2f NovaVert(NovaQuadVert v, uint instanceID : SV_InstanceID, uint vid : SV_VERTEXID)
{
    ...
    SubQuadVert vert = _NovaSubQuadVerts[vertIndex];
    UIBlock2DData shaderData = _NovaData[vert.BlockDataIndex];
