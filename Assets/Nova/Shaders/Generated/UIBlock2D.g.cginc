		...
		#define SetNCornerOrigin(val, toSet) val.Packed1.zw = toSet
			...
			#define SetRadialFillSinCos(val, toSet) val.Packed2.zw = toSet
				...
				#define SetBorderColor(val, toSet) val.BorderColor = toSet
					...
					#define GetBorderNWidth(val) val.Packed3.y
					#define SetBorderNWidth(val, toSet) val.Packed3.y = toSet
					#define GetNShadowRadius(val) val.Packed3.z
					#define SetNShadowRadius(val, toSet) val.Packed3.z = toSet
					...
					#define SetShadowColor(val, toSet) val.ShadowColor = toSet
							...
							#define GetSmoothness(val) val.Packed5.w
							#define SetSmoothness(val, toSet) val.Packed5.w = toSet
							#define GetEdgeSoftenDisabled(val) val.Packed6.x
							#define SetEdgeSoftenDisabled(val, toSet) val.Packed6.x = toSet
							#define GetSpecularColor(val) val.Packed6.yzw
							#define SetSpecularColor(val, toSet) val.Packed6.yzw = toSet
						...
						#define SetNCornerRadius(val, toSet) val.Packed3.w = toSet
							...
							#define GetWorldPos(val) val.Packed5.xyz
							#define SetWorldPos(val, toSet) val.Packed5.xyz = toSet
							#define GetBorderNWidth(val) val.Packed5.w
							#define SetBorderNWidth(val, toSet) val.Packed5.w = toSet
							#define GetImageUV(val) val.Packed6.xy
							#define SetImageUV(val, toSet) val.Packed6.xy = toSet
						...
						#define GetNCornerRadius(val) val.Packed3.z
						#define SetNCornerRadius(val, toSet) val.Packed3.z = toSet
		...
		#define SetRadialFillSinCos(val, toSet) val.Packed2.zw = toSet
				...
				#define SetBorderColor(val, toSet) val.BorderColor = toSet
					...
					#define SetShadowColor(val, toSet) val.ShadowColor = toSet
						...
						#define GetNShadowOrigin(val) val.Packed5.xy
						#define SetNShadowOrigin(val, toSet) val.Packed5.xy = toSet
						#define GetNShadowSpacePos(val) val.Packed5.zw
						#define SetNShadowSpacePos(val, toSet) val.Packed5.zw = toSet
						#if defined(NOVA_LAMBERT_LIGHTING)
							#define GetWorldPos(val) val.Packed6.xyz
							#define SetWorldPos(val, toSet) val.Packed6.xyz = toSet
							#define GetEdgeSoftenDisabled(val) val.Packed6.w
							...
							#define GetWorldPos(val) val.Packed6.xyz
							#define SetWorldPos(val, toSet) val.Packed6.xyz = toSet
							#define GetSpecular(val) val.Packed6.w
							#define SetSpecular(val, toSet) val.Packed6.w = toSet
							#define GetImageUV(val) val.Packed7.xy
							#define SetImageUV(val, toSet) val.Packed7.xy = toSet
							#define GetGloss(val) val.Packed7.z
							#define SetGloss(val, toSet) val.Packed7.z = toSet
							...
							#define GetImageUV(val) val.Packed7.xy
							#define SetImageUV(val, toSet) val.Packed7.xy = toSet
							#define GetMetallic(val) val.Packed7.z
							#define SetMetallic(val, toSet) val.Packed7.z = toSet
							#define GetEdgeSoftenDisabled(val) val.Packed7.w
							#define SetEdgeSoftenDisabled(val, toSet) val.Packed7.w = toSet
							#define POST_NOVA_0 12
							#define POST_NOVA_1 13
						...
						#define GetNShadowOrigin(val) val.Packed5.xy
						#define SetNShadowOrigin(val, toSet) val.Packed5.xy = toSet
						#define GetNShadowBlur(val) val.Packed5.z
						#define SetNShadowBlur(val, toSet) val.Packed5.z = toSet
						#define GetEdgeSoftenDisabled(val) val.Packed5.w
						#define SetEdgeSoftenDisabled(val, toSet) val.Packed5.w = toSet
					#endif
				#else
						...
						#define GetBorderNWidth(val) val.Packed4.x
						#define SetBorderNWidth(val, toSet) val.Packed4.x = toSet
						#define GetEdgeSoftenDisabled(val) val.Packed4.y
						#define SetEdgeSoftenDisabled(val, toSet) val.Packed4.y = toSet
					#endif
				#endif
				...
				half4 Packed2 : TEXCOORD4;
					...
					fixed4 BorderColor : TEXCOORD5;
						...
						fixed4 ShadowColor : TEXCOORD8;
								...
								// yzw: SpecularColor
								fixed4 Packed6 : TEXCOORD10;
								float3 WorldPos : TEXCOORD11;
								float2 ImageUV : TEXCOORD12;
							#endif
						#else
							// xy: ImageUV
							// z: EdgeSoftenDisabled
							float3 Packed5 : TEXCOORD9;
						#endif
					#else
						#if defined(NOVA_LIT)
							// xyz: WorldNormal
