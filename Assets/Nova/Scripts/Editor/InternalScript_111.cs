...
namespace Nova.InternalNamespace_17.InternalNamespace_22
{
    ...
    internal static class InternalType_718
    {
        ...
        public static void InternalMethod_3228(Bounds InternalParameter_2945, Bounds InternalParameter_2946)
        {
            InternalMethod_3229(InternalParameter_2945, InternalParameter_2946);
        }

        private static void InternalMethod_3229(Bounds InternalParameter_2947, Bounds InternalParameter_2948)
        {
            Color InternalVar_1 = Handles.color;
            Color InternalVar_2 = InternalVar_1;
            InternalVar_2.a *= 0.5f;

            Handles.color = InternalVar_2;
            Vector2 InternalVar_3 = new Vector2(InternalParameter_2948.min.x - InternalParameter_2947.min.x, InternalParameter_2947.size.y);
            Vector3 InternalVar_4 = new Vector3(InternalParameter_2948.min.x - InternalVar_3.x * 0.5f, InternalParameter_2947.center.y, InternalParameter_2948.center.z);
            InternalMethod_3230(InternalVar_4, InternalVar_3);

            Vector2 InternalVar_5 = new Vector2(InternalParameter_2947.max.x - InternalParameter_2948.max.x, InternalParameter_2947.size.y);
            Vector3 InternalVar_6 = new Vector3(InternalParameter_2948.max.x + InternalVar_5.x * 0.5f, InternalParameter_2947.center.y, InternalParameter_2948.center.z);
            InternalMethod_3230(InternalVar_6, InternalVar_5);

            Vector2 InternalVar_7 = new Vector2(InternalParameter_2948.size.x, InternalParameter_2947.max.y - InternalParameter_2948.max.y);
            Vector3 InternalVar_8 = new Vector3(InternalParameter_2948.center.x, InternalParameter_2948.max.y + InternalVar_7.y * 0.5f, InternalParameter_2948.center.z);
            InternalMethod_3230(InternalVar_8, InternalVar_7);

            Vector2 InternalVar_9 = new Vector2(InternalParameter_2948.size.x, InternalParameter_2948.min.y - InternalParameter_2947.min.y);
            Vector3 InternalVar_10 = new Vector3(InternalParameter_2948.center.x, InternalParameter_2948.min.y - InternalVar_9.y * 0.5f, InternalParameter_2948.center.z);
            InternalMethod_3230(InternalVar_10, InternalVar_9);

            Handles.color = InternalVar_1;
        }

        public static void InternalMethod_3230(Vector3 InternalParameter_2949, Vector2 InternalParameter_2950)
        {
            Vector3 InternalVar_1 = 0.5f * InternalParameter_2950;

            Vector3 InternalVar_2 = InternalParameter_2949 + Vector3.Scale(new Vector3(-1, -1, 0), InternalVar_1); 
            Vector3 InternalVar_3 = InternalParameter_2949 + Vector3.Scale(new Vector3(1, -1, 0), InternalVar_1); 

            Vector3 InternalVar_4 = InternalParameter_2949 + Vector3.Scale(new Vector3(1, 1, 0), InternalVar_1); 
            Vector3 InternalVar_5 = InternalParameter_2949 + Vector3.Scale(new Vector3(-1, 1, 0), InternalVar_1); 

            Handles.DrawAAConvexPolygon(InternalVar_2, InternalVar_3, InternalVar_4, InternalVar_5);
        }
