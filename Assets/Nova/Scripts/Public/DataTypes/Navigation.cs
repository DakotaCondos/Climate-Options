    ...
    public static class Navigation
    {
        ...
        public static void Move(Vector3 direction, uint controlID = 0, object userData = null, int layerMask = AllLayers)
        {
            ...
            for (int InternalVar_7 = 0; InternalVar_7 < InternalVar_4; ++InternalVar_7)
            {
                ...
                bool InternalVar_9 = InternalVar_8 != null && InternalVar_8.InternalProperty_23.InternalProperty_1152;

                if (InternalVar_9)
                {
                    Update InternalVar_10 = new Update(InternalType_757<UIBlock>.InternalMethod_3583(direction, InternalVar_8, InternalParameter_3305: true), controlID, userData);
                    InternalVar_8.InternalMethod_91(Navigate.InternalMethod_461(InternalVar_10, InternalVar_8, direction));
                    return;
                }
                ...
                {
                    InternalType_5 InternalVar_10 = InternalVar_5 != null ? InternalVar_5 : InternalVar_1;
                    InternalType_757<UIBlock>.InternalMethod_3637(InternalVar_10, controlID, InternalVar_7);
            ...
            InternalType_738 InternalVar_11 = InternalVar_6 == InternalType_764.InternalField_1557 ? InternalType_738.InternalMethod_2801(InternalVar_1, InternalVar_5 as UIBlock, new Update(InternalType_757<UIBlock>.InternalMethod_3583(direction, InternalVar_1), controlID, userData), direction, layerMask) :
                                                            InternalType_738.InternalMethod_2815(controlID, direction, userData, layerMask);

            InternalProperty_1082.Add(InternalVar_11);
        }
            ...
            if (!InternalVar_6 && InternalVar_2 != null && InternalVar_1 == null)
            {
                ...
                switch (InternalVar_9.Fallback)
                {
                    ...
                    case NavLinkFallback.NavigateOutsideScope:
                        ...
                        while (InternalVar_1 == null && InternalVar_11 != null)
                        {
        ...
        private static InternalType_738 InternalMethod_2823(InternalType_738 InternalParameter_2457)
        {
            ...
            {
                throw new System.InvalidOperationException($"Navigation not initialized. {nameof(Focus)} must be called at least once with the same {nameof(InternalVar_1)} prior to any calls to {nameof(Move)}.");
            }
