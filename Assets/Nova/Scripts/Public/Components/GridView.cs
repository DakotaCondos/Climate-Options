...
namespace Nova
{
    ...
    public sealed class GridView : ListView, ISerializationCallbackReceiver
    {
        ...
        public int CrossAxisItemCount => crossAxisItemCount;
        ...
        private protected override void InternalMethod_2060(bool firstSibling)
        {
            ...
            if (firstSibling)
            {
                for (int InternalVar_2 = 0; InternalVar_2 < crossAxisItemCount && InternalVar_1.InternalProperty_84 - InternalVar_2 > 0; ++InternalVar_2)
                {
        ...
        private protected override InternalType_66 InternalMethod_227(bool InternalParameter_173)
        {
            InternalType_33 InternalVar_1 = InternalMethod_201(InternalParameter_173);

            if (InternalParameter_173)
            {
                for (int InternalVar_2 = 0; InternalVar_2 < crossAxisItemCount; ++InternalVar_2)
                {
            ...
            InternalVar_1.InternalMethod_442();

            InternalProperty_54.InternalMethod_59(InternalVar_1.InternalProperty_83);
