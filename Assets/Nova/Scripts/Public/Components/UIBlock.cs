...
namespace Nova
{
    ...
    public class UIBlock : CoreBlock, InternalType_5
    {
        ...
        public ref readonly Length.Calculated CalculatedSpacing
        {
            get
            {
                return ref UnsafeUtility.As<InternalNamespace_0.InternalType_45.InternalType_47, Length.Calculated>(ref InternalType_457.InternalProperty_190.InternalMethod_1858(this));
            }
        }
