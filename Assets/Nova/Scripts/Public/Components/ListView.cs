    ...
    public class ListView : MonoBehaviour, InternalType_29, ISerializationCallbackReceiver
    {
        ...
        public void SetDataSource<T>(IList<T> dataSource)
        {
            ...
            if (dataSource != null && UIBlock.InternalProperty_25)
            {
                ...
                {
                    Debug.LogWarning($"AutoLayout.AutoSpace is not supported on ListViews and will likely lead to issues when populating the ListView with list items if enabled.", this);
                }
        ...
        /// </summary>
        /// <remarks>If the detach succeeds, the <paramref name="listItem"/>'s parent will be set to <paramref name="newParent"/>.</remarks>
        /// <param name="sourceIndex">The index of the object in the data source</param>
        /// <param name="listItem">The list item visual reprensenting the object at index <paramref name="sourceIndex"/></param>
        ...
        public void Refresh()
        {
            ...
            bool InternalVar_2 = InternalVar_1 && InternalField_99 < InternalField_98;

            if (InternalVar_2)
            {
                InternalField_99 = DataSourceItemCount - 1;
                InternalField_98 = DataSourceItemCount;

                InternalMethod_218(InternalParameter_162: false);
                JumpToIndex(InternalField_99);
            }
            else
            {
        ...
        public void Relayout()
        {
            ...
            {
                float InternalVar_4 = InternalProperty_56.InternalProperty_549[InternalVar_3];

                if (InternalProperty_56.InternalProperty_1 <= InternalVar_4 && DataSourceItemCount > 0)
                {
                    InternalVar_1 = InternalMethod_2686(InternalVar_2.ReverseOrder ? DataSourceItemCount - 1 : 0, InternalParameter_2246: false);
                }
                else if (InternalField_99 == DataSourceItemCount - 1)
                {
                    float InternalVar_5 = InternalVar_2.Alignment == 0 ? -1 : InternalVar_2.Alignment * 0.5f;
                    InternalVar_1 = InternalVar_2.Offset * InternalVar_5;
                }
            }

            Scroll(InternalVar_1);

            if (InternalField_98 == 0 && InternalField_99 == DataSourceItemCount - 1)
            {
        ...
        internal void InternalMethod_211(float InternalParameter_161)
        {
            if (!UIBlock.InternalProperty_25 || InternalProperty_55 == null || InternalProperty_55.InternalProperty_431)
            {
                return;
            ...
            float InternalVar_1 = Math.InternalMethod_882(InternalParameter_161 - InternalProperty_56.InternalProperty_3);
        ...
        [System.Diagnostics.DebuggerBrowsable(System.Diagnostics.DebuggerBrowsableState.Never)]
        private InternalType_1 InternalProperty_56 => this;
        ...
        private float InternalMethod_222(int InternalParameter_165)
        {
            ...
            float InternalVar_2 = (float)InternalParameter_165 / InternalProperty_52;
        ...
        InternalType_66 InternalType_1.InternalMethod_43(bool InternalParameter_36, float InternalParameter_37)
        {
            ...
            InternalType_66 InternalVar_3 = InternalMethod_227(InternalParameter_173: InternalVar_1);
        ...
        private protected virtual InternalType_66 InternalMethod_227(bool InternalParameter_173)
        {
            return InternalParameter_173 ? InternalMethod_228(InternalParameter_174: true) : InternalMethod_229(InternalParameter_175: true);
        }
