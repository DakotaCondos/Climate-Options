...
namespace Nova
{
    ...
    internal class InternalType_2 : System.IDisposable
    {
        ...
        private bool InternalMethod_52(float InternalParameter_41, ref InternalType_3 InternalParameter_42)
        {
            ...
            float InternalVar_3 = InternalField_16.InternalProperty_18[InternalVar_2] - (float)InternalField_24.InternalField_26[InternalVar_2];
            float InternalVar_4 = InternalField_16.InternalProperty_19[InternalVar_2] - InternalProperty_11[InternalVar_2];

            int InternalVar_5 = InternalParameter_41 == 0 ? (int)math.sign(InternalType_187.InternalMethod_882(InternalVar_4 - 0.5f * InternalVar_3)) : (int)math.sign(InternalParameter_41);

            InternalParameter_42 = new InternalType_3(ref InternalVar_1, InternalField_16.InternalProperty_18, InternalParameter_41, InternalField_16.CalculatedSpacing.Value, InternalVar_5, InternalVar_2);
            InternalProperty_11 = InternalField_16.InternalProperty_19;

            if (InternalField_18 || InternalVar_5 == 0)
            {
                return false;
            }
            ...
            InternalField_19.InternalField_574 = InternalVar_5;
